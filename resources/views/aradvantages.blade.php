            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="hero-captions text-center">
                        <h2 class="hero-title">  لماذا يجب أن تختارنا ؟</h2>
                        <p class="hero-text c">اذا كنت ترغب في ترجمة ملفاتك في شركة ترجمة معتمدة بأقصى سرعة و بدقة عالية فأنت في المكان الصحيح </p>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mb60 section-title text-center">
                        <h1 class="wi">اذا كنت تتسأل لماذا تختار شركتنا ؟</h1>
                        <p class="wi c">لدينا الأجابة لأسئلتك يمكنك قرأتها بالأسفل </p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="feature mb40 pinside40 text-center">
                        ...
                        <div class="feature-content">
                            <h3 class="wi">الأحترافية</h3>
                            <p class=" wi"> نحن نضم أهم خبراء في مجال الترجمة لذلك نحن نضمن لك ترجمة محترفة بدقة عالية </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="feature  mb40 pinside40 text-center">
                        ...
                        <div class="feature-content">
                            <h3 class="wi">اقل الأسعار</h3>
                            <p class=" wi"> نحن نضمن لك ترجمة أحترافية بأقل الأسعار </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="feature  mb40 pinside40 text-center">
                        ...
                        <div class="feature-content">
                            <h3 class="wi">الدقة و الكفاءة</h3>
                            <p class=" wi">نحن نقوم بترجمة ملفاتك بدقة و كفاءة عالية </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="feature  mb40 pinside40 text-center">
                        ...
                        <div class="feature-content">
                            <h3 class="wi">السرعة</h3>
                            <p class=" wi"> أذا كان وقتك ضيق و تريد ترجمة معتمدة بأسرع ما يمكن </p>
                        </div>
                    </div>
                </div>
            </div>
