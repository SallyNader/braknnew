            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li class="c" style="font-size: 19px" ><a href="{{url('arabic-home')}}" >الصفحة الرئيسية</a></li>
                            <li class="active c" style="font-size: 19px" >للتواصل معنا</li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="bg-white pinside30">
                        <div class="row">
                            <div class="col-md-4 col-sm-5">
                                <h1 class="page-title">للتواصل معنا</h1>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb60  section-title">
                                        <!-- section title start-->
                                        <h1 class="al">نحنا هنا لخدمتك </h1>
                                        <p class="lead al">يمكنك التواصل معنا للحصول على معلومات أو يمكنك أرسال ترجمتك عبر الأنترنت  </p>
                                    </div>
                                    <!-- /.section title start-->
                                </div>
                            </div>
