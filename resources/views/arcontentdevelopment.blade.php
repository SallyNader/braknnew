...
<!--    <div class="col-md-1 hidden-sm">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="hero-captions">
                        <h2 class="hero-title">خدمة انشاء المحتوى والتطوير</h2>
                        <p class="hero-text"> </p>
            ...
            <div class="row">
                ...
                <div class="col-md-offset-1 col-md-5">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb60">
                                <h1 class="al">لديك فكرة ولكنك لا تعرف كيف تكتب او التعبير عنها بلغة اخرى ؟ </h1>
                                <p></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                ...
                                <div class="feature-content">
                                    <h3 class="al" >لماذا تحتاج الى كتابة محتوى  وتطويره ؟</h3>
                                    <p class="c al">محتوى المحتوى هو سر نجاجك, فكرتك لن تشرح و تفسر دون الكلمات المناسبة لشرحها ,لذلك محتوى ملفتك هو سر نجاحك  </p>
                                </div>
                            </div>
                        </div>
 ...
 <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3 class="al" > كيف تضمن ان يتم اختيار الكلمات المناسبة لشرح  او المنتج او الخدمة بشكل صحيح ؟ </h3>
                                    <p class="c al"> هنا يأتي دور المترجم في شرح فكرتك  , مترجمينا سيقوموا بشرح فكرتك بأحترافية شديدة </p>
                                </div>
                            </div>
                        </div>
