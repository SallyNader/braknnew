...
<head>
    ...
    <meta name="description" content="we translate word documents,pdf,Certificates, Contracts and agreements, Corporate letters, Dictionaries, Letters/Emails, Logo,Scientific , Software, Surveys, User guides, Video, Voice over scripts, Web sites.">
    <meta name="keywords" content="Financial Website Template, Bootstrap Template, Loan Product, Personal Loan">
    <title>we translate word documents|pdf|Certificates|Contracts and agreements| Corporate letters|Dictionaries|Letters/Emails|Logo.</title>
    <!-- Bootstrap -->
  ...
  <div class="page-header">
                ...
                <div class="col-md-12">
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="active c" >أنواع الملفات التي نقوم بترجمتها</li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="bg-white pinside30">
                        <div class="row">
                            <div class="col-md-4 col-sm-5">
                                <h1 class="page-title al" style="text-align: center;">أنواع الملفات التي نقوم بترجمتها</h1>
                            </div>
                            <div class="col-md-8 col-sm-7">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="btn-action c"> <a href="{{url('arabic-online-translation')}}" class="btn btn-default c">أرسل ملفاتك ليتم ترجمتها</a> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class=" ">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12" >
                <div class="section-scroll pinside60" id="section-about" style="height: 1500px">
                            <h1 class="al">ماهي أنواع الملفات و الوثائق التي نقوم بترجمتها</h1>
                            
                            <div class="row">
                            
                                <p></p>
                                <p></p>
<p class="lead al">نحن نقوم بترجمة جميع أنواع الملفات و الوثائق</p>
<div class="col-md-6 col-sm-6 al"  style="margin-left: 150px">
                                  <!--  <p class="c al">تبعا لنوع الوثائق الاساسية , سيكلف اللغويين ذوى الخبرة فى الترجمة لتلبية احتياجات المشروع الخاص بك ,هذا سيضمن لك ترجمة صحيحة تصل بها الى أهدفك </p>-->
                                </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 50px">
                                <div class="portfolioFilter "> <a href="#" data-filter="*" class="current c" style="font-size: 14px" >كل</a> <a href="#" data-filter=".car-loan" class="" style="font-size: 14px">عقود</a><a href="#" data-filter=".car-loan" class="" style="font-size: 14px">المراسلات</a> <a href="#" data-filter=".personal-loan" class="" style="font-size: 14px">السجلات الطبية</a> <a href="#" data-filter=".home-loan" class="" style="font-size: 14px">النشرات الترويجية التسويقية</a> <a href="#" data-filter=".education-loan" class="" style="font-size: 14px">المستندات الحكومية</a>

                                <a href="#" data-filter=".education-loan" class="" style="font-size: 14px"> المواد التعليمية</a>

                                <a href="#" data-filter=".education-loan" class="" style="font-size: 14px">ترجمة مواقع</a>

                                <a href="#" data-filter=".education-loan" class="" style="font-size: 14px">كتب</a>
                                <a href="#" data-filter=".education-loan" class="" style="font-size: 14px">شهادات ميلاد</a>
                                <a href="#" data-filter=".education-loan" class="" style="font-size: 14px">الرخص</a>
                                <a href="#" data-filter=".education-loan" class="" style="font-size: 14px">مراسيم الطلاق</a>
                                <a href="#" data-filter=".education-loan" class="" style="font-size: 14px">اعلانات</a>
                                <a href="#" data-filter=".education-loan" class="" style="font-size: 14px">المعلومات المالية</a>


<a href="#" data-filter=".education-loan" class="" style="font-size: 14px">الاحكام القضائية</a>
                                </div>
                            </div>
                        </div>
                            <div class="row">
                        ...
                        <!--<div class="row">
                            <div id="effect-6" class="effects clearfix">
                                <div class="portfolioContainer">
                                    <div class="col-md-4 col-sm-4  car-loan personal-loan home-loan col-xs-12">
                                        <div class="gallery-thumbnail mb30">
                                            <div class="img"> <img src="images/blog-post-1.jpg" alt="Borrow - Loan Company Website Template" class="img-responsive">
                                                <div class="overlay"> <a href="#" class="expand">+</a> <a class="close-overlay hidden">x</a> </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-4  education-loan  car-loan personal-loan col-xs-12">
                                        <div class="gallery-thumbnail mb30">
                                            <div class="img"> <img src="images/blog-post-2.jpg" alt="Borrow - Loan Company Website Template" class="img-responsive">
                                                <div class="overlay"> <a href="#" class="expand">+</a> <a class="close-overlay hidden">x</a> </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-4  home-loan education-loan car-loan col-xs-12">
                                        <div class="gallery-thumbnail mb30">
                                            <div class="img"> <img src="images/blog-post-3.jpg" alt="Borrow - Loan Company Website Template" class="img-responsive">
                                                <div class="overlay"> <a href="#" class="expand">+</a> <a class="close-overlay hidden">x</a> </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-4  personal-loan  home-loan education-loan col-xs-12">
                                        <div class="gallery-thumbnail mb30">
                                            <div class="img"> <img src="images/blog-post-4.jpg" alt="Borrow - Loan Company Website Template" class="img-responsive">
                                                <div class="overlay"> <a href="#" class="expand">+</a> <a class="close-overlay hidden">x</a> </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-4 car-loan personal-loan  home-loan col-xs-12">
                                        <div class="gallery-thumbnail mb30">
                                            <div class="img"> <img src="images/blog-post-5.jpg" alt="Borrow - Loan Company Website Template" class="img-responsive">
                                                <div class="overlay"> <a href="#" class="expand">+</a> <a class="close-overlay hidden">x</a> </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-4 car-loan personal-loan  home-loan col-xs-12">
                                        <div class="gallery-thumbnail mb30">
                                            <div class="img"> <img src="images/blog-post-6.jpg" alt="Borrow - Loan Company Website Template" class="img-responsive">
                                                <div class="overlay"> <a href="#" class="expand">+</a> <a class="close-overlay hidden">x</a> </div>
                                            </div>
                                        </div>
                                    </div>
