...
<!--    <div class="col-md-1 hidden-sm">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="hero-captions">
                        <h2 class="hero-title">التعريب</h2>
                        <p class="hero-text"> </p>
                       <!-- <div class="price-rate">
                        ...
                        <a href="{{url('arabic-online-translation')}}" class="btn btn-default btn-sm c"> أرسل ملفاتك ليتم ترجمتها</a>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-offset-1 col-md-5">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb60">
                                <h1 class="al" >البراق تقدم خدمة التعريب المعتمدة في جميع اللغات </h1>
                                <p></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                ...
                                <div class="feature-content">
                                    <h3 class="al">لماذا تحتاج الي تعريب مستنداتك ؟</h3>
                                    <p class="al c">التعريب هو تغير لغة ملفاتك الى لغة تناسب السوق أو المكان التي سيقدم له الأوراق و المستندات </p>
                                </div>
                            </div>
                        </div>
 ...
 <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3 class="al">نحن نوفر تعريب البرامج</h3>
                                    <p class="al c">يتم تعريب البرامج سواء تطبيق على الموبيل أو المواقع الألكترونية الى مختلف اللغات </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3 class="al">فنحن نساعدك على تطوير شركتك</h3>
                                    <p class="al c">سنساعدك على تطوير شركتك و تعريب برامجك لتناسب السوق المنافس  </p>
                                </div>
                            </div>
                        </div>
