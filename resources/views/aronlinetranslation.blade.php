...
<head>
    ...
    <meta name="description" content="you can translate a pdf document from german to english and other languages ,we provide certified translation services online , we guarantee the best translation services online , fill form for online language translation services">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="hero-captions text-center">
                        <h2 class="hero-title">خدمة أرسال الترجمة عبر الأنترنت</h2>
                        <p class="hero-text c">البراق توفر لك خدمة أرسال ملفتك عبر لاأنترنت لترجمة ملفتك  </p>
                ...
                <div class="col-md-offset-1 col-md-10 col-xs-12 col-sm-12">
                    <div class="request-form">
                        <h2 class="form-title al"> أرسل ملفك ليتم ترجمته</h2>
                        <p class="c al">البراق توفر خدمة الترجمة عبر الأنترنت لتوفر لك وقتك  </p>
                        <form class="row" method="post" action="{{url('online-translation')}}">

                        {{ csrf_field() }}
                            <!-- Text input-->
                            <div class="form-group col-md-6">
                                <label class="control-label sr-only  al" for="name" >أسم الشركة</label>
                                <input id="name" name="business" type="text" placeholder="أسم الشركة" class="form-control input-md" value="{{old('business')}}" >
                                <p style="color:#f51f8a">{{$errors->first('business')}}</p>
                            </div>
                            <!-- Text input-->

                            <div class="form-group col-md-6">
                                <label class="control-label sr-only" for="city">اللغة الاصلية</label>
                                <select id="city" name="source" class="form-control">
                                 <option value="Arabic">الغة الاصلية</option> 
                ...
                <option value="other">Other</option>
                            ...
                            <div class="form-group col-md-6">
                                <label class="control-label sr-only" for="email">مستوى الخبرة</label>
                                <input id="email" name="volume" type="text" placeholder="مستوى الخبرة" class="form-control input-md" value="{{old('volume')}}" >

                                <p style="color:#f51f8a">{{$errors->first('volume')}}</p>
                            </div>
                             <div class="form-group col-md-6">
                                <label class="control-label sr-only" for="city">اللغة المراد الترجمة اليها</label>
                                <select id="city" name="target" class="form-control">
                                 <option value="Arabic">اللغة المراد الترجمة اليها</option> 
                                   <option value="Arabic">Arabic</option> 
                <option value="Bulgarian">Bulgarian</option> 
                <option value="Catalan">Catalan</option>
                <option value="Chinese(Simplified)">Chinese (Simplified)</option> 
                ...
                <option value="other">Other</option>
                            ...
                            <!-- Text input-->
                            <div class="form-group col-md-6">
                                <label class="control-label sr-only" for="phone">مجال الترجمة </label>
                                <input id="phone" name="field" type="text" placeholder="مجال الترجمة " class="form-control input-md" value="{{old('field')}}" >

                                <p style="color:#f51f8a">{{$errors->first('field')}}</p>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="control-label sr-only" for="email">ملاحظات</label>
                                <input id="email" name="comment" type="text" placeholder="ملاحظات" class="form-control input-md"  value="{{old('comment')}}">
                                <p style="color:#f51f8a">{{$errors->first('comment')}}</p>
                            </div>
                            <div class="form-group" style="padding-left: 20px">
                                <label >ارفق الملف</label>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <button type="submit" class="btn btn-default btn-block">أرسال</button>
                            </div>
                        </form>
                    </div>
                </div>
