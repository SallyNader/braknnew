                ...
                <div class="col-md-12">
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="active c">خبراء الترجمة</li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="bg-white pinside30">
                        <div class="row">
                            <div class="col-md-4 col-sm-5 col-xs-12">
                                <h1 class="page-title">خبراء الترجمة</h1>
                            </div>
                            <div class="col-md-8 col-sm-7 ol-xs-12">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="btn-action"> <a href="{{url('arabic-online-translation')}}" class="btn btn-default c"> أرسل ملفاتك ليتم ترجمتها</a> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8">
                                        <div class="mb60 text-center section-title title-white">
                                            <!-- section title start-->
                                            <h1 class="title-white">يقود شركة البراق أحد أمهر المديرين في شركات الترجمة في مصر</h1>
                                            <p></p> <p></p>
                                            <p class="c wi" style="color: #f51f8a">مديرنا التنفيذي خبرة أكثر من 10 سنوات في عدة شركات كبرى  </p>
                                            <ul style="padding-bottom: 2px">
                                                

                                                <li class="c al">مديرنا التنفيذي حاصل على شهادة خبرة في الترجمة من الجامعة الأمريكية </li>
                                                <li class="c al">شهادة النيبوش العامة الدولية في مجال الصحة و السلامة المهنية مع درجة الأمتياز من مركز دراسات الخدمات الصحية</li>
                                            </ul>
                                        </div>
                                        <!-- /.section title start-->
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="section-title text-center mb60">
                                            <h1>من المسؤول على ترجمة ملفاتك ؟</h1>
                                            <h3>مترجمينا ذو خبرة واسعة في مجال الترجمة يضمن لكم ترجمة ممتازة دون أخطاء </h3>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-md-offset-2 col-md-8 col-xs-12">
                    <div class="mb100 text-center section-title" style="padding-right: 70px">
                        <!-- section title start-->
                        <h1>الخبرات التي حصل عليها مترجمينا </h1>
                        <p></p>
                    </div>
                    <!-- /.section title start-->
                </div>
            ...
            <div class="row" style="width: 1000px">
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="bg-white pinside40 number-block outline mb60 bg-boxshadow">
                        ...
                        <p>
                       مترجمينا حاصلين على شهادة جامعية في اللغات الأجنبية  </p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="bg-white pinside40 number-block outline mb60 bg-boxshadow">
                        ...
                        <h3 class="number-title"></h3>
                        <p> لغوين حاصلين على ليسنس في الترجمة أو درجة علمية أعلى في أكثر من لغة </p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-12" >
                    <div class="bg-white pinside40 number-block outline mb60 bg-boxshadow">
                        ...
                        <div class="about-section pinside40">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <h2 class="mb30 al">تريد أن تعرف من المسؤل عن ترجمة وثائقك ؟ </h2>
                                    <p class="lead mb30 al">يقوم بترجمة وثائقك أحد خبرائنا في الترجمة الحاصلين على شهادات خبرة في لغات عديدة </p>
                                    <p> </p>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                    <div class="mb60">
                                        <h2 class="mb30 al">التخصص هو سر نجاجنا </h2>
                                        <p class="lead mb30 al">, البراق لديها فريق عمل كامل لجميع اللغات في جميع التخصصاتكل من خبرائنا متخصص في لغة معينة , البراق لديها فريق عمل كامل لجميع اللغات في جميع التخصصات </p>
                                        <p></p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="text-center">
                                        <div class="icon"> <i class="icon-4x icon-users icon-default"></i>
                                            ...
                                            <div class="small-title c">عملاء أختاروا البراق</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="text-center">
                                        <div class="icon"> <i class="icon-4x icon-dialog icon-default"></i>
                                            ...
                                            <div class="small-title c">تصويت العملاء</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8" style="padding-right:  150px">
                    <div class="mb60 text-center section-title">
                        <!-- section title-->
                        <h1>للتواصل معنا </h1>
                        <p>أختر أحد الطرق للتواصل معنا </p>
                    </div>
                    <!-- /.section title-->
                </div>
            </div>
