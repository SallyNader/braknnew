...
.al{
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="hero-captions">
                        <h2 class="hero-title">مراجعة و تصحيح الوثائق</h2>
                        <p class="hero-text"> </p>
                       <!-- <div class="price-rate">
                        ...
                        <a href="{{url('arabic-online-translation')}}" class="btn btn-default btn-sm c">أرسل الملفات المراد ترجمتها</a>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-offset-1 col-md-5">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb60">
                                <h1>هل تبحث عن شركة معتمدة لمراجعة و تصحيح وثائقك ؟ البراق توفر لك مراجعة و تصحيح معتمدة لوثائقك </h1>
                                <p></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                ...
                                <div class="feature-content">
                                    <h3 class="al " >ما أهمية مراجعة و تصحيح وثائقك ؟  </h3>
                                    <p class="al c">من المهم تقديم الوثائق خالية من الأخطاء الأملائية و النحوية الي الجهة المقدمة لها و هنا يأتي دورنا في مراجعة و تصحيح وثائقك  </p>
                                </div>
                            </div>
                        </div>
 ...
 <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3 class="al ">كيف نضمن لك مراجعة وثائقك بدقة عالية ؟  </h3>
                                    <p class="al c">نحن نقوم بقراءة و تحليل وثائقك جيدا و نقوم بتصحيح الأخطاء الأملائية و النحوية </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3 class="al ">لماذا تحتاج الوئائق الي تعديل و تصحيح ؟ </h3>
                                    <p class="al c">اذا كنت قد ترجمت أوراقك فمن المهم المراجعة عليها قبل تقديمها  </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3 class="al ">اذا كنت قد ترجمت أوراقك في شركة أخرى و لاكنك تشك في صحة الترجمة يمكنك مراجعتها في شركتنا للتأكد من صحتها  </h3>
                                    <p class="al c">اذا كنت تريد التأكد من صحة أوراقك المترجمة فنحن نضمن لك مراجعة و تصحيح محترفة يقوم بها أمهر المترجمين عندنا </p>
                                </div>
                            </div>
                        </div>
