...
<head>
    ...
    <meta name="description" content="we have professional simultaneous translation rates in egypt , we are following simultaneous translation techniques">
    <meta name="keywords" content="Financial Website Template, Bootstrap Template, Loan Product, Personal Loan">
    <title>simultaneous transcription and translation|simultaneous translation techniques</title>
    <!-- Bootstrap -->
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="hero-captions">
                        <h2 class="hero-title">ترجمة فورية  </h2>
                        <p class="hero-text"> </p>
            ...
            <div class="row">
                ...
                <div class="col-md-offset-1 col-md-5">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb60">
                                <h1 class="al" >البراق تقدم خدمة الترجمة الفورية المعتمدة </h1>
                                <p></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                ...
                                <div class="feature-content">
                                    <h3 class="al">شركة البراق رائدة في مجال الترجمة الفورية </h3>
                                    <p class="al c">البراق تحتل مكانة واسعة في مجال الترجمة الفوية المعنمدة يقوم بها خبراء الترجمة الفوية لدينا , و هم يستطيعون ترجمة أصعب المناقشات و الندوات </p>
                                </div>
                            </div>
                        </div>
