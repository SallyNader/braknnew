            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="hero-captions">
                        <h2 class="hero-title">خدمة النسخ </h2>
                        <p class="hero-text"> </p>
            ...
            <div class="row">
                ...
                <div class="col-md-offset-1 col-md-5">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb60">
                                <h1 class="al"> البراق رائدة في مجال النسخ بأحترافية</h1>
                                <p></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                ...
                                <div class="feature-content">
                                    <h3 class="al">هل أنت ممن  يبحث عن الجودة و الأحترافية ؟ </h3>
                                    <p class="c al">البراق تضمن لك الأحترافية و الدقة في مجال النسخ و الترجمة </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3 class="al">خدمة النسخ تتضمن الأجتماعات والندوات وغير ذلك بجميع اللغات</h3>
                                    <p class="al c">نحن نضم خدمات النسخ و الترجمة للاجتماعات والندوات وغير ذلك الي جميع اللغات بحترافية و دقة عالية </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3 class="al">ترجمتنا معتمدة بأسعار مناسبة  </h3>
                                    <p class="al c"> البراق تقدم خدمة النسخ المعتمدة بالتعون مع أفضل خبراء الترجمة و بأسعار مناسبة لجميع العملاء </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3 class="al">السرعة </h3>
                                    <p class="al c">البراق تقدم خدمة النسخ بدقة عالية و سرعة عالية لتوفير وقتك الثمين </p>
                                </div>
                            </div>
                        </div>
                    </div>
