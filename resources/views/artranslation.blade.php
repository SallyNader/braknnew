...
<!--    <div class="col-md-1 hidden-sm">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="hero-captions">
                        <h2 class="hero-title">ترجمة الملفات و الوثائق </h2>
                        <p class="hero-text"> </p>
            ...
            <div class="row">
                ...
                <div class="col-md-offset-1 col-md-5">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb60">
                                <h1>البراق تقدم خدمة ترجمة الملفات و الوثائق باحترافية لمساعدتك عل تحقيق أهدفك  </h1>
                                <p></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                ...
                                <div class="feature-content">
                                    <h3 class="al">هل أنت ممن يبحثون عن الدقة و الصلابة في ترجمة الملفات و الوثائق ؟ </h3>
                                    <p  class="al c">البرق شركة ترجمة معتمدة موثوقة في مجال الترجمة تقدم خدمات عدية بدقة عالية و في وقت قياسي </p>
                                </div>
                            </div>
                        </div>
 ...
 <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3  class="al">معظم شركات مصر تفضل الترجمة في شركتنا   </h3>
                                    <p  class="al c"> ترجمتنا المعتمدة هي أختيار 500 شركة من كبار الشركات و المنظمات الغير هادفة </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3  class="al">خدمتنا تشمل ترجمة من و الى جميع اللغات بمختلف أنواع الوثائق و الملفات </h3>
                                    <p  class="al c"> ترجمتنا المعتمدة تقدم ترجمة الي جميع اللغات حوالي 200 لغة و تشمل جميع أنواع الملفات و الوثائق </p>
                                </div>
                            </div>
                        </div>
                    </div>
