                    ...
                    <div class="bg-white pinside30">
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <h1 class="page-title" style="text-align:center">ترجمة الفيديو و الملفات الصوتية</h1>
                            </div>
                            ...
                            <div class="row">
                                <div class=" ">
                                    ...
                                    <div class=" ">
                                            ...
                                            <div class="col-md-12">
                                                <h2 class="al">أهمية ترجمة الملفات الألكترونية مثل الملفات الصوتية و الفيديو</h2>
                                            </div>
                                            <div class="col-md-8 col-sm-8 al" style ="margin-left:120px">
                                                <p class="c al">من المهم ترجمة  الملفات الألكترونية لتتمكن من مخاطبة مختلف البلاد , البراق تدعم ترجمة جميع الملفات الألكترونية الي مختلف اللغات , خبرائنا سيساعدوك على ترجمة ملفتك لمختلف الصيغ اذا اردت بدقة و أحترافية </p>
                                            </div>
                                            <div class="col-md-4 col-sm-4">
                                                <p class="c al"></p>
                                            </div>
                                        ...
                                        <div class="row column-block">
                                            <div class="col-md-12 col-sm-12">
                                                <h2  class="al">ما أنواع صيغ الملفات التي نترجمها</h2>
                                            </div>
