            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="hero-captions">
                        <h2 class="hero-title">ترجمة المواقع الألكترونية</h2>
                        <p class="hero-text"> </p> <!-- <div class="price- rate">
<div class="new- price"><span class="price- big">8.70% </span><small>for new
car</small></div> <div class="old- price"><span class="price-
big">9.70%</span><small>for new car</small></div> </div>--> <a href="{{url('arabic-online-translation')}}"
class="btn btn-default btn- sm  c">أرسل الملفات المراد ترجمتها</a> </div> </div>
<!-- <div class="col-md-5 col-md- offset-1 col- xs-12"> <div class="request-
form"> <h2>Request Quote Now</h2> <p>Easy to apply for a loan with us,Once you
action="http://jituchauhan.com/borrow/borrow/get- quote.php">
have complete this form. </p> <form method="post"
            ...
            <div class="row">
                ...
                <div class="col-md-offset-1 col-md-5">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb60">
                                <h1>ماذا نقصد عند ذكر ترجمة المواقع الألكترونية</h1>
                                <p></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                ...
                                <div class="feature-content">
                                    <h3 class="al">ما أهمية ترجمة موقعك لعدة لغات مختلفة ؟ </h3>
                                    <p class="al c" > اذا كنت ممن يرغبون بالتوسع في جميع أنحاء الدول يجب ترجمة موقعك الي اللغة التي تريد أن تتنافس في بلدها ليمكن عملائك من فهم منتجتك و الخدمات التي تقدمها </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3 class="al"> البراق لديها خبرة في ترجمة و تعريب المواقع الألكترونية</h3>
                                    <p class="al c">نحن خبراء في مجال ترجمة و تعريب المواقع الألكترونية سواء الكبيرة أو الصغيرة , و قمنا بترجمتها الى مختلف اللغات  </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3 class="al">كيف أصبحنا رائدين في مجال ترجمة و تعريب المواقع الألكترونية ؟ </h3>
                                    <p class="al c">نحن نتبع منهجية في ترجمة الموقع الألكتروني , نقوم بوضع محتوي مناسب لمجال الموقع , مثلا اذا كان الموقع يخاطب مجال الهندسة , نقوم بوضع محتوي يناسب مجال الهندسة و كذلك لباقي المجالات   </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3 class="al">البراق ستساعدك للتقدم في السوق على الأنترنت   </h3>
                                    <p class="al c">أكثر من 50 % من زوار موقعك لا يتحدثون لغة بلدك , مهمتنا هي ترجمة موقعك لتتمكن من مخاطبة زوار موقعك من مختلف البلاد   </p>
                                </div>
                            </div>
                        </div>
                    </div>
