                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="slider-captions">
                                <!-- slider-captions -->
                                <h1 class="slider-title">we guarantee you accuracy <strong class="text-highlight">100%</strong></h1>
                                <p class="slider-text hidden-xs">We provide an excellent professional translation service for all types of documents for different purposes
                                    <br> </p>
                                <a href="{{url('online-translation')}}" class="btn btn-default hidden-xs">send online Translation</a> </div>
                            <!-- /.slider-captions -->
                        </div>
                    </div>
                </div>
...
" class="btn btn-primary">Online Translation</a>
                        ...
                        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                    <div class="panel-body">we provide Document Translation (<a href="{{url('translation-service/document-translation')}}">See Our Document Translation</a>), Document Proofreading(<a href="{{url('translation-service/document-proofreading-editing')}}">See Our Document Proofreading</a>),Simultaneous Translation (<a href="{{url('translation-service/simultaneous-interpretation')}}">See our Simultaneous Translation</a>),Website Translation(<a href="translation-service/website-translation">See Our Website Translation</a>),Transcription(<a href="{{url('translation-service/document-transcription')}}">See Our Transcription) ,Content Development and Creation(<a href="{{url('translation-service/content-development')}}">See Our Content Development and Creation  </a>),Audio and Video Interpreting (<a href="{{url('translation-service/video-audio-interpretation')}}">See Our Interpreting</a>),Localization(<a href="{{url('translation-service/localization')}}">See Our Localization</a>)and Staffing/outsourcing. </div>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                ...
                                <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                                    <div class="panel-body">alboraq is certified professional translation service who awarded EGYTA (<a href="{{url('certifications')}}">See Our Accreditations</a>). </div>
                                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" role="tab" id="headingFour">
                                    <h4 class="panel-title"> <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseu" aria-expanded="false" aria-controls="collapseFour"> What About Our Pricing ?</a> </h4>
                                </div>
            ...
            <div class="row">
                <div class="col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                    <div class="mb60 text-center section-title">
                        ...
                        <p>we translate all types of documents for all types of purposes <a href="{{url('document-type-we-translate')}}">See Document Types We Translate</a></p>
                    </div>
                    <!-- /.section title start-->
                </div>
            </div>
    ...
    <div class="bg-white section-space80">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8 text-center"> <a href="{{url('about\contact-us')}}" class="btn btn-default">Visit Us And Get Your Translation Service</a> </div>
            </div>
        </div>
    </div>
    <div class="section-space80">
                    ...
                    <div class="testimonial-block mb30">
                        ...
                        <div class="testimonial-autor-box">
                            ...
                            <div class="testimonial-autor pull-left">
                                ...
                                <span class="testimonial-meta">Global Drilling and Completions, Europe, Eurasia and North Africa</span> </div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 col-xs-12">
                    <div class="bg-white bg-boxshadow pinside40 outline text-center mb30">
                        ...
                        <a href="{{url('about\translator-jobs')}}" class="btn-link">Apply For Job Online</a> </div>
                </div>
            </div>
        </div>
    </div>
