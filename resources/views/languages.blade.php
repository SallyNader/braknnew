            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="hero-captions">
                        <h2 class="hero-title">Alboraq Provides All Foreign Language For Your Translation Service Needs.</h2>
                        <p class="hero-text"> </p>
    ...
    <ul class="nav col-md-2" id="leftTabs" style="margin-top: 80px">
      <li class="active">
        <a href="#a_tab" data-toggle="tab">
          <span></span><strong style="color: #f51f8a;font-size: 130%">Popular</strong>        </a>
      </li>
      <li>
        <a href="#b_tab" data-toggle="tab">
          <span></span><strong style="color: #f51f8a;font-size: 130%">A</strong>
        </a>
      </li>
    <!--  <li>
      ...
      <li>
        <a href="#d_tab" data-toggle="tab">
          <span></span>  <strong style="color: color: #f51f8a;font-size: 130%"> B</strong>
        </a>
      </li>

      <li>
        <a href="#e_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">C</strong>
        </a>
      </li>
      ...
      <li>
        <a href="#f_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">D</strong>
        </a>
      </li>
      ...
      <li>
        <a href="#g_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">E</strong>
        </a>
      </li>
      ...
      <li>
        <a href="#h_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">F</strong>
        </a>
      </li>
      <li>
        <a href="#i_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">G</strong>
        </a>
      </li>
      <li>
        <a href="#j_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">H</strong>
        </a>
      </li>
      <li>
        <a href="#k_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">I</strong>
        </a>
      </li>
      <li>
        <a href="#l_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">J</strong>
        </a>
      </li>
      <li>
        <a href="#m_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">K</strong>
        </a>
      </li>
      ...
      <li>
        <a href="#n_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">L</strong>
        </a>
      </li>
      ...
      <li>
        <a href="#o_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">M</strong>
        </a>
      </li>
      ...
      <li>
        <a href="#p_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">N</strong>
        </a>
      </li>
      ...
      <li>
        <a href="#q_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">O</strong>
        </a>
      </li>
      ...
      <li>
        <a href="#r_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">P</strong>
        </a>
      </li>
      ...
      <li>
        <a href="#s_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">Q</strong>
        </a>
      </li>
      ...
      <li>
        <a href="#t_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">R</strong>
        </a>
      </li>
      ...
      <li>
        <a href="#u_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">S</strong>
        </a>
      </li>
      ...
      <li>
        <a href="#v_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">T</strong>
        </a>
      </li>
      ...
      <li>
        <a href="#w_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">U</strong>
        </a>
      </li>
      ...
      <li>
        <a href="#x_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">V</strong>
        </a>
      </li>
      ...
      <li>
        <a href="#y_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">W</strong>
        </a>
      </li>
      ...
      <li>
        <a href="#z_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">X</strong>
        </a>
      </li>
      ...
      <li>
        <a href="#aa_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">Y</strong>
        </a>
      </li>

 <li>
        <a href="#bb_tab" data-toggle="tab">
          <span></span> <strong style="color: #f51f8a;font-size: 130%">Z</strong>
        </a>
      </li>
    ...
    <div class="tab-content col-md-10" style="text-align: left;margin-top: 80px">
      <div class="tab-pane active" id="a_tab">
        ...
        <h3 style="color: #f51f8a">English Translation</h3>
