...
<li><a href="{{url('translation-service/website-translation')}}" title="Team" class="animsition-link">Website Translation</a></li>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="hero-captions">
                        <h2 class="hero-title">Localization</h2>
                        <p class="hero-text"> </p>
            ...
            <div class="row">
                ...
                <div class="col-md-offset-1 col-md-5">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb60">
                                <h1>Alboraq provides Certified Professional localization for all languages </h1>
                                <p></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                ...
                                <div class="feature-content">
                                    <h3>Why Do You Need Localization ?</h3>
                                    <p> Localization is the adaptation of your product or service to account for the differences of a particular market, including translation, technical modifications, regulatory modifications, etc.</p>
                                </div>
                            </div>
                        </div>
 ...
 <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3>We Have Software Localization</h3>
                                    <p> Software localization is more than translating software into different languages. It is making a web application, mobile app or on-premises software product linguistically and culturally appropriate.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3>We Help You To Progress Your Business</h3>
                                    <p>We’re proud to work with some of the world’s most progressive and dynamic businesses, building localization and translation programs that drive their go-to-market strategies.</p>
                                </div>
                            </div>
                        </div>
