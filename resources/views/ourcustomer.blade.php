                ...
                <div class="col-md-12">
                    <div class="wrapper-content bg-white pinside40">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="mb60">
                                    <p class="lead">our trusted translation company is the choice of 500 companies, top government agencies and non-profit organizations.</p>
                                </div>
                            </div>
                        </div><div class="compare-block mb30">
                            <div class="compare-title bg-primary pinside20">
                                <h3 class="mb0">Oriental Weavers Group</h3>
                            </div>
                            <div class="compare-row outline pinside30">
                                <div class="row">
                                    <div class="col-md-2 col-sm-12 col-xs-12"> <img src="{!!asset('images/our-customer10.jpg')!!}" alt="Borrow - Loan Company Website Template"> </div>
                                     <div class="col-md-2 col-sm-2 col-xs-6" >
                                        <div class="text-center" style="padding-left:60px;width:600px;text-align: justify;    text-justify: inter-word;">
                                            <h3 class="rate"></h3>
                                            <p style="padding-left:220px; word-wrap: break-word;padding-top:20px"> Oriental Weavers Group is one of the world’s largest carpet, rug and related raw materials producers. Based in Cairo, the group has manufacturing facilities in three countries and distributes its products in more than 130 countries worldwide.</p> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="compare-block mb30">
                            <div class="compare-title bg-primary pinside20">
                                <h3 class="mb0">ASEC Automation</h3>
                            </div>
                            <div class="compare-row outline pinside30">
                                <div class="row">
                                    <div class="col-md-2 col-sm-12 col-xs-12"> <img src="{!!asset('images/our-customer1.jpg')!!}" alt="Borrow - Loan Company Website Template"> </div>
                                    <div class="col-md-2 col-sm-2 col-xs-6" >
                                        <div class="text-center" style="padding-left:60px;width:600px;text-align: justify;    text-justify: inter-word;">
                                            <h3 class="rate"></h3>
                        ...
                        <div class="compare-block mb30">
                            ...
                            <div class="compare-row outline pinside30">
                             ...
                             <div class="compare-block mb30">
                            <div class="compare-title bg-primary pinside20">
                                <h3 class="mb0">RASHPETCO</h3>
                            </div>
                            <div class="compare-row outline pinside30">
                                <div class="row">
                                    <div class="col-md-2 col-sm-12 col-xs-12"> <img src="{!!asset('images/our-customer13.jpg')!!}" alt="Borrow - Loan Company Website Template" > </div>
                                     <div class="col-md-2 col-sm-2 col-xs-6" >
                                        <div class="text-center" style="padding-left:60px;width:600px;text-align: justify;    text-justify: inter-word;">
                                            <h3 class="rate"></h3>
                                            <p style="padding-left:220px; word-wrap: break-word;padding-top:20px"> The Rashid Petroleum Company (RASHPETCO), a subsidiary of Egypt’s Oil Ministry, is intensifying its operations to cope with the government’s plan to meet the local demand on natural gas, Chairman and Managing Director Mohamed El-Masry said.</p> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
