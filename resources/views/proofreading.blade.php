...
<head>
    ...
    <title>editing and proofreading pdf|certificate in editing and proofreading|english editing and proofreading</title>
    <meta name="description" content="Alboraq certificate in editing and proofreading,we editing and proofreading pdf,we provide book editing and proofreading,english editing and proofreading,also online proofreading and editing">
    <meta name="keywords" content="certificate in editing and proofreading,what is the difference between proofreading and editing,what is the difference between editing and proofreading,editing and proofreading pdf,the difference between proofreading and editing,the difference between editing and proofreading,professional proofreading and editing services,book editing and proofreading,translation editing proofreading,proofreading and editing service,english editing and proofreading,proofreading editing service,editing proofreading services,online proofreading and editing,professional editing and proofreading,editing and proofreading service,online editing and proofreading,certified german translation services,certified french translation services,certified translation services birth certificate,best translation services online,free translation services online,website translation services reviews,free online document translation services">
    <!-- Bootstrap -->
...
<li><a href="{{url('translation-service/website-translation')}}" title="Team" class="animsition-link">Website Translation</a></li>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="hero-captions">
                        <h2 class="hero-title">Document Proofreading And Editing</h2>
                        <p class="hero-text"> </p>
                       <!-- <div class="price-rate">
                        ...
                        <a href="{{url('online-translation')}}" class="btn btn-default btn-sm"> Send Your Document For Online Translation</a>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-offset-1 col-md-5">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb60">
                                <h1>If You Don't Know Where To Proofread/Edit Your Documents !! Alboraq Deliver You Certified Professional Proofreading/Editing Documents </h1>
                                <p></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                ...
                                <div class="feature-content">
                                    <h3>Why Do You Need Proofreading And Editing Your Documents ?</h3>
                                    <p> The essence of proofreading is the reading of a document or piece of text in order to identify and correct any errors.</p>
                                </div>
                            </div>
                        </div>
 ...
 <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3>How We Guarantee You Professional Proofreading ! </h3>
                                    <p> our proofreading service includes the analysis of content, organization, coherence, tone, and style of text,we also double check for any spelling, grammar, punctuation and capitalization errors.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3>Why Your Documents Need To Be Edited !</h3>
                                    <p>your documents need  editing to check and resolve problems with previously translated materials.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3>If You Aren't Satisfied wih Your Previous Translated Document In Another Company You Can Check It In our Agency</h3>
                                    <p>whether you want to double check your translated text or you are not happy with the original translation, Alboraq has expert editors ready to review your documentation.</p>
                                </div>
                            </div>
                        </div>
