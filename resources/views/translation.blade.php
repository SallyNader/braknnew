...
<li><a href="{{url('translation-service/website-translation')}}" title="Team" class="animsition-link">Website Translation</a></li>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="hero-captions">
                        <h2 class="hero-title">Document Translation Service </h2>
                        <p class="hero-text"> </p>
            ...
            <div class="row">
                ...
                <div class="col-md-offset-1 col-md-5">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb60">
                                <h1>Alboraq Provides Professional Translation Services That Will Help You To Achieve Your Goal</h1>
                                <p></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                ...
                                <div class="feature-content">
                                    <h3>You Are Searching For Accuracy And Reliability</h3>
                                    <p> owe are trusted translation agency who offers fast, accurate and reliable professional translation services.</p>
                                </div>
                            </div>
                        </div>
 ...
 <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3>Most Of Companies In Egypt Choose Alboraq  </h3>
                                    <p> our trusted translation company is the choice of  500 companies, top government agencies and non-profit organizations.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3>All Types Of Ducument And All Languages Included</h3>
                                    <p> Our professional translation services include language translations of all types of documents, in all formats, lengths and languages,with the ability to translate to and from over 200 languages.</p>
                                </div>
                            </div>
                        </div>
                    </div>
