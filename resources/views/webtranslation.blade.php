            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="hero-captions">
                        <h2 class="hero-title">Website Translation</h2>
                        <p class="hero-text"> </p>
            ...
            <div class="row">
                ...
                <div class="col-md-offset-1 col-md-5">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb60">
                                <h1>what we mean when we say Website Translation !</h1>
                                <p></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                ...
                                <div class="feature-content">
                                    <h3>Importance Of Translate Your Website To Multiple languages!</h3>
                                    <p> As the cornerstone of the new economy, your website can be your most valuable marketing tool. Hence, having your site in multiple languages can have an exponential affect on your sales and online presence.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3>We Are Expertise In Web Translation</h3>
                                    <p> Alboraq has worked with large, medium and small entities and translated their websites and built multilingual platforms.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3>Why We Are Expertise</h3>
                                    <p> To effectively translate your website translation, we specialize in content that includes highly technical terms in areas such as Engineering, IT, Internet, Hardware, Electronics, Physics, Mechanical, Electrical, Manufacturing, Automation and many others. </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3>Alboraq Will Help Your organization To Grow In Online Market </h3>
                                    <p>Over 50% of all Internet traffic is from non-English-speaking countries. We can help you develop a truly global Internet presence. The online market has been growing at double digit rates annually for the past five years and will likely continue to do so.</p>
                                </div>
                            </div>
                        </div>
                    </div>
