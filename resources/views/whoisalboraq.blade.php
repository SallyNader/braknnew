                ...
                <div class="col-md-12">
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Who Is Alboraq</li>
                        </ol>
                    </div>
                </div>
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="bg-white pinside30">
                        <div class="row">
                            <div class="col-md-5 col-sm-4 col-xs-4">
                                <h1 class="page-title">Who Is Alboraq</h1>
                            </div>
                    ...
                    <div class="sub-nav" id="sub-nav">
                        <ul class="nav nav-justified">
                         <li><a href="#section-eleigiblity" class="page-scroll"><div class="rate-block" style="text-align: center;">
                                            <h1 class="rate-number">100%</h1>
                                            <small>Rate of accuracy</small> </div></a></li>
                            <li><a href="#section-about" class="page-scroll"><div class="rate-block" style="text-align: center;">
                                            <h1 class="rate-number">5000 +</h1>
                                            <small>Business Customers</small> </div></a></li>
                            <li><a href="#section-typeloan" class="page-scroll"><div class="rate-block" style="text-align: center;">
                                            <h1 class="rate-number">200 +</h1>
                                            <small>Languages</small> </div></a></li>
                            <li><a href="#section-feature" class="page-scroll"><div class="rate-block" style="text-align: center;">
                                            <h1 class="rate-number">5,000 +</h1>
                                            <small>Type Of Documents</small> </div></a></li>
                ...
                <div class="col-md-12">
                    <div class="wrapper-content bg-white">
                        <div class="section-scroll pinside60" id="section-about">
                            <h1>Alboraq Is Leader in Translation and Interpretation Services</h1>
                            <p class="lead" style="padding-top: 50px;padding-bottom: 50px">Alboraq is leader in multilingual translation and interpretation services with expert linguists and over 5,000 satisfied clients. Alboraq is the choice of Fortune 500 companies, top government agencies and non-profit organizations. </p>
                           <!-- <div class="row">
...
<h2 style="color: #f51f8a" >Alboraq Is A Full-Service Multilingual Translation Service Provider</h2>
<p>With the ability to translate to and from over 200 languages, Alboraq is a full-service multilingual translation service provider.Alboraq has proven experience handling translation projects of all sizes and is a one-stop solution for any organization seeking superior translations at highly competitive rates.</p>

                                	</li>

<li>
                                		
<h2 style="color: #f51f8a" >Alboraq Provides 24/7 Service</h2>
<p>The office provides 24/7 service including weekends & national holidays. Our Objective is to provide accurate & quick translation services. If you have tight deadlines, our team will always meet your expectations.</p>
...
<h2 style="color: #f51f8a" >Alboraq Guarantees of Quality at the Most Competitive Prices</h2>
<p>We are committed to providing you with the highest quality translations at the most competitive price points in the industry.</p>

                                	</li>

                                	<li>
                                		
<h2 style="color: #f51f8a" >Alboraq Is The Home Of Professional Translators </h2>
<p>our translation team is highly qualified and very experienced , they are Government-accredited translators ,they have professional background with linguists with BA or higher academic degrees in one or more foreign languages.</p>

                                	</li>


                                </ul>
                                <a href="{{url('online-translation')}}" style="margin-left: 250px;margin-top: 50px" class="btn btn-default">Send Online Translation</a> </div>
                        </div>
                        <div class="section-scroll" id="section-typeloan">
                            <div class="bg-light pinside60">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="section-title mb60" style="text-align: left;">
                                            <h1>Who Lead Our Certified Professional Translation Agency ?</h1>
                                            <h2 style="color: #f51f8a;padding-top: 39px">Alboraq Is Being Supervised By An Expert Executive Director Who Has More Than 10 Years Experience In Multinational Firms And Was Awarded:</h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="feature-content">
                                    <h3>The Professional Certificate in Written Translation from the American University in Cairo.</h3>
                                ...
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3>Nebosh International General Certificate in Occupational Safety & Health with Distinction from CHSS.</h3>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="bg-white bg-boxshadow pinside40 outline text-center mb30">
                        ...
                        <a href="{{url('online-translation')}}" class="btn-link">Send Your Translation</a> </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="bg-white bg-boxshadow pinside40 outline text-center mb30">
